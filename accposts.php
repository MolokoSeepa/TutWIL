...
<small><a style="color:red;"  href="logout.php" onclick="w3_close()">Logout</a></small><br>
  <small><a style="color:blue;" href='ac_profile.php?<?php echo "u_id=$user_id" ?>'  href="ac_profile.php?u_id=$userown_id">Profile</a></small><hr><hr><hr><hr>
...
<div class="container">
  <div class="row">
     ...
     <form action="accposts.php?id=<?php echo $user_id;?>" method="post" id="f" enctype='multipart/form-data'>
