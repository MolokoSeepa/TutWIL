...
include('functions/funcTutEng.php');
?>
<?php
...
<a style='text-decoration: none;cursor: pointer;color: #3897f0;' href='eng_profile.php?u_id=$user_id'><br>$name</a><br>
	...
	<div class='col-sm-8'>
			...
			<?php
				...
				$get_posts = "select * from engposts where user_id='$u_id' ORDER by 1 DESC LIMIT 5";
				...
				echo "
					<div style='width-width: 300px;' class='row'>
                     <div style='width-width: 350px; class='w3-col'>
                      <div class='w3-col-6'>
                       <div class='w3-card w3-round w3-white'>
						       <p class='text-secondary'><a style='text-decoration: none;cursor: pointer;color: #3897f0;' href='eng_profile.php?u_id=$user_id'><img src='user/$user_image'class='w3-left w3-circle w3-margin-right' style='width:30px'>$user_name</a>$user_position<br>$post_date</p><hr>
                            <small><p class='text-secondary'>$content</p></small><hr>

                            <a href='singleeng.php?post_id=$post_id' style='float:right;'><button class='btn btn-info'>Comment</button></a><br>
...
<div class='row'>
          ...
          <div class='w3-card w3-round w3-white'>
            <div class='w3-container w3-padding'>
                  <h6 class='text-secondary'><img src='user/$user_image'class='w3-margin-right w3-circle w3-margin-right' style='width:40px'><a style='text-decoration: none;cursor: pointer;color: #3897f0;' href='eng_profile.php?u_id=$user_id'>$user_name</a>$user_position<br>$post_date</h6>
                 <img id='engposts-img' src='imagepost/$upload_image' style='width:100%'><hr>
        ...
        <div class='w3-col m7'>
          <div class='w3-card w3-round w3-white'>
            <div class='w3-container w3-padding'>
						...
						<h6 class='text-secondary'><img src='user/$user_image'class='w3-margin-right w3-circle w3-margin-right' style='width:40px'><a style='text-decoration: none;cursor: pointer;color: #3897f0;' href='eng_profile.php?u_id=$user_id'>$user_name</a>$user_position<br>$post_date</h6><hr>
