...
body{
    ...
    background-image: url('img/gradu.jpg');
...
<div class="form-group">
      <input type="text" class="form-control" id="username" placeholder="Enter TUT Email" name="email" required>
    </div>
<div class="form-group">
     <input type="password" class="form-control" placeholder="Enter password" id="password" name="pass" required>
    </div>
<button class="btn btn-success btn-block" name="submit" type="submit"><i class="fa fa-lock"></i><small>Graduate/Undergraduate LOG IN</small></button>
 <a href="indexStaff.php" class="btn btn-secondary btn-block"><small>Staff Login</small></a>
   <a href="signup.php" class="btn btn-primary btn-block"><small>REGISTER</small></a>
</form>
</div>
</div>
</div>
