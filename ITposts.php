...
<?php 
      ...
      $user_posts = "select * from user where user_id='$user_id' AND user_courseName='$user_courseName'"; 
...
<small><a style="color:red;"  href="logout.php" onclick="w3_close()">Logout</a></small><br>
  <small><a style="color:blue;" href='user_profile.php?<?php echo "u_id=$user_id" ?>'  href="user_profile.php?u_id=$userown_id">Profile</a></small><hr><hr><hr><hr>
...
<div class="w3-top">
  <div class="w3-teal w3-large" style="max-width:1000px;margin:auto">
    ...
    <div class="w3 w3-padding-16"><h5 class="w3-text-white"><i class='fa fa-info'></i>Graduates Tweets</h5></div>
  </div>
</div>
...
<div class="container">
  <div class="row">
     ...
     <form action="ITposts.php?id=<?php echo $user_id;?>" method="post" id="f" enctype='multipart/form-data'>
...
<section id="faq" class="faq wow fadeInUp">
    ...
    <input type='file' name='upload_file' size="200">
    </label>
  </div><br>
    ...
    <button  id="btn-post" class="btn btn-secondary btn-block" name="sub">Done</button><br>
      <a class="w3-left w3-padding-3 w3-icon"  href="messeges.php">
       <?php 
                   
$rt = mysqli_query($con,"SELECT * FROM user");
$num1 = mysqli_num_rows($rt);
{?>
   <span style="color: teal">View Graduates/Undergraduates 
     </span></a><br>Registered Users <?php echo htmlentities($num1);
