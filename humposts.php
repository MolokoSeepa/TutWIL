...
<small><a style="color:red;"  href="logout.php" onclick="w3_close()">Logout</a></small><br>
  <small><a style="color:blue;" href='hum_profile.php?<?php echo "u_id=$user_id" ?>'  href="hum_profile.php?u_id=$userown_id">Profile</a></small><hr><hr><hr><hr>
...
<div class="container">
  <div class="row">
     ...
     <form action="humposts.php?id=<?php echo $user_id;?>" method="post" id="f" enctype='multipart/form-data'>
...
<section id="faq" class="faq wow fadeInUp">
    ...
    <button id="btn-post" class="btn btn-primary btn-block" name="sub">Post</button><br>
      <a class="w3-left w3-padding-6 w3-icon"  href="messeges.php">
        <?php 
                   
$rt = mysqli_query($con,"SELECT * FROM user");
$num1 = mysqli_num_rows($rt);
{?>
   <span style="color: teal">Unicom users: </span><big><?php echo htmlentities($num1);?></big>
