...
<small><a style="color:red;"  href="logout.php" onclick="w3_close()">Logout</a></small><br>
  <small><a style="color:blue;" href='art_profile.php?<?php echo "u_id=$user_id" ?>'  href="art_profile.php?u_id=$userown_id">Profile</a></small><hr><hr><hr><hr>
...
<div class="container">
  <div class="row">
     ...
     <form action="artposts.php?id=<?php echo $user_id;?>" method="post" id="f" enctype='multipart/form-data'>
      <div class="form-group">
      <label for="text"></label>
      <textarea class="form-control" id="content" name="content" required>Post a question and share insights with us:
...
<section id="faq" class="faq wow fadeInUp">
    ...
    <button id="btn-post" class="btn btn-primary btn-block" name="sub">Post</button><br>
      <a class="w3-left w3-padding-6 w3-icon"  href="messeges.php"><small><h5 class=w3-text-teal><b>Messeges</b></h5></small></a>
