...
<small><a style="color:red;"  href="logout.php" onclick="w3_close()">Logout</a></small><br>
  <small><a style="color:blue;" href='eng_profile.php?<?php echo "u_id=$user_id" ?>'  href="eng_profile.php?u_id=$userown_id">Profile</a></small><hr><hr><hr><hr>
...
<div class="container">
  <div class="row">
     ...
     <form action="engposts.php?id=<?php echo $user_id;?>" method="post" id="f" enctype='multipart/form-data'>
